...
@Component
public class AuthenticationEntryPointFailureHandler implements AuthenticationEntryPoint {
    @Override
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        apiErrorResponse.getErrors().add(ExceptionUtils.createErrorResponse(new NotAuthorizedException(errorCode, errorMessage, errorParams)));
