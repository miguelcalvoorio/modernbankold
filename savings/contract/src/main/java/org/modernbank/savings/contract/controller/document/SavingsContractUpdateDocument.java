...
@ApiOperation(
    value = "This operations allow update a contract\r\n",
    notes = "Users and clients can update the following contract data:\r\n"
...
public @interface SavingsContractUpdateDocument {}
