...
@ApiOperation(
    value = "This operations removes a contract from Modernbank\r\n",
    notes = "Remove a contract and cannot be undone\r\n"
          + "Contract must have a CLOSED status\r\n",
...
public @interface SavingsContractDeleteDocument {}
