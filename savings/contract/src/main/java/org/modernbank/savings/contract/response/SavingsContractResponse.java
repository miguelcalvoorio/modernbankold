...
public class SavingsContractResponse extends RepresentationModel<SavingsContractResponse> {
    ...
    private List<SavingsContractParticipantResponse> participantsList;
